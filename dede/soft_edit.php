        ...
        if(is_array($dtp->CTags))
        {
            foreach($dtp->CTags as $ctag)
            {
                if($ctag->GetName()=='link')
                {
                    ...
                    $nForm .= "<div style='line-height:36px'>图片地址{$newRowStart}：<input type='text' name='softurl{$newRowStart}' style='width:280px' value='".trim($ctag->GetInnerText())."' />
...
else if($dopost=='save')
{
    ...
    $msg = "
    　　请选择你的后续操作：
    <a href='soft_add.php?cid=$typeid'><u>发布新图片</u></a>
    &nbsp;&nbsp;
    <a href='archives_do.php?aid=".$id."&dopost=editArchives'><u>继续修改</u></a>
    &nbsp;&nbsp;
    <a href='$arcUrl' target='_blank'><u>查看图片</u></a>
    &nbsp;&nbsp;
