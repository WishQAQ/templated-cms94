...
Picasa.prototype = {
	...
	// 参数
	loadingImage	: '/templets/default/Picasa/Picasa_Loading.gif',		// 加载中提示图片路径
	errorImage		: '/templets/default/Picasa/Picasa_Error.gif',		// 加载错误提示图片路径
	...
	initialize : function() {
		...
		for (var i=0; i<count; i++){
			...
			if (rel.match(/picasa/i)){
				...
				anchors[i].onclick = function(){self.display(this); this.blur(); return false;}
