    ...
    if($dopost=='regbase')
    {
       ...
       '0','$spaceSta','','$safequestion','$safeanswer','$jointime','$joinip','$logintime','$loginip'); ";
        if($dsql->ExecuteNoneQuery($inQuery))
        {
            ...
            //写入其它默认数据
            $dsql->ExecuteNoneQuery("INSERT INTO `#@__member_flink`(mid,title,url) VALUES('$mid','必诺软件','http://mirosoft.taobao.com'); ");
            ...
            if($cfg_mb_spacesta==-10)
            {
                ...
                $mailbody .= "{$url}\r\n\r\n";
                $mailbody .= "Power by http://www.softs123.com 必诺软件--专业网站建设！\r\n";
